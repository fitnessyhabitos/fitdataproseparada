...
console.log("⚡ FIT DATA: Iniciando App v10.4 (Final Fix)...");
...
// La pantalla de carga se muestra al principio por HTML/CSS.
// JS solo la quita cuando está todo listo o por seguridad.
let appReady = false;
...
window.switchCoachPose = (pose) => {
    ...
    // IDs correctos del HTML de Coach
