...
console.log("⚡ FIT DATA: Iniciando App v10.2 (Corrección Visual & iOS)...");
...
// --- CORRECCIÓN CRÍTICA CARGA IOS ---
// El loader DEBE eliminarse con un retraso, pero SOLO después de verificar auth.
// Usamos un flag para no duplicar llamadas.
let appInitialized = false;

onAuthStateChanged(auth, async (user) => {
    if(appInitialized) return; 

    // Ocultar loader tras 2.5s pase lo que pase
    setTimeout(() => { 
